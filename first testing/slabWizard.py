...
class Draw(AppShell.AppShell):
    ...
    contactname     = 'Tony Giannetti'
    contactemail    = 'tony%sgiannetti%scom%sau' % ('@', '.', '.')
    frameWidth      = 840
    frameHeight     = 600
    catchCntr = False
    ...
    def createBase(self):
        self.sidebar = self.createcomponent('sidebar', (), None,
        ...
        self.toolbar = self.createcomponent('toolbar', (), None,
                  Frame, (self.interior(),), background="gray80")
        self.toolbar.pack(side=LEFT, fill=X, expand=False)
